          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/50">
                <th className="px-8 py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest whitespace-nowrap">{t.full_name}</th>
                ...
                students.map(s => (
                  <tr key={s.id} className="hover:bg-gray-50/30 transition-colors">
                    <td className="px-8 py-6">
                      ...
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-1">{t.student_active}</p>
                    </td>
                    <td className="px-8 py-6">
